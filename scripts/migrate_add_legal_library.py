...
from legal_library import LegalDocument, Citation, DocumentAnnotation, LegalTopic
...
def create_legal_library_tables():
    ...
    try:
        ...
        initial_topics = [
            ('Constitutional Law', 'Issues related to constitutional interpretation and application'),
