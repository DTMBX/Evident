...
RIGHTS_PROFILES = {
    ...
    "our_transcript": DataRights(
        ...
        source_name="BarberX Legal Tech - AI Transcript",
        export_allowed=True,
        attribution_required=True,
        attribution_text="Transcript generated by BarberX Legal Tech using Whisper AI (MIT License)",
...
class RightsAwareExport:
    ...
    def finalize_export(
        ...
        with open(attribution_path, 'w') as f:
            ...
            f.write(f"https://barberx.info/licenses\n")
