...
We are grateful to Free Law Project for their mission to make the law more accessible. Consider supporting their work: https://free.law/donate/
...
We believe in contributing to the open-source ecosystem that makes our work possible:

- **Bug Reports:** We report and help fix bugs in upstream projects
- **Documentation:** We contribute documentation improvements
- **Sponsorship:** We sponsor open-source projects financially when possible
- **Community:** We share our learnings with the developer community
...
BarberX Legal Technologies is committed to:

1. **Proper Attribution:** Always crediting the creators of tools we use
2. **License Compliance:** Strictly adhering to all open-source license terms
3. **Community Support:** Contributing back to projects we depend on
4. **Transparency:** Openly acknowledging our technology stack
...
While we use open-source tools, the BarberX Legal Technologies platform itself, including our proprietary algorithms, analysis pipelines, and user interface designs, remain the exclusive property of Faith Frontier Ecclesiastical Trust. See [LICENSE](LICENSE) for details.

**Third-Party Trademarks:**  
All trademarks mentioned in this document are property of their respective owners. No endorsement or affiliation is implied.

**Accuracy:**  
We strive to maintain accurate attribution. If you notice any errors or omissions, please contact us at legal@barberx.info.

---

**With gratitude to the open-source community,**  
**The BarberX Legal Technologies Team**
