...
class APIPricingCalculator:
    ...
    # Pricing per 1K tokens (as of 2025) - Updated to reflect latest rates
    # Note: Audio transcription models (whisper, deepgram) are priced per MINUTE
    PRICING = {
        "openai": {
            # GPT-5 series (2025)
            "gpt-5.2": {"prompt": 0.00175, "completion": 0.014},  # $1.75/1M in, $14/1M out
            "gpt-5-mini": {"prompt": 0.00025, "completion": 0.002},  # $0.25/1M in, $2/1M out
            # GPT-4.1 series
            "gpt-4.1": {"prompt": 0.002, "completion": 0.008},  # Standard rates
            "gpt-4.1-mini": {"prompt": 0.0004, "completion": 0.0016},
            "gpt-4.1-nano": {"prompt": 0.0001, "completion": 0.0004},
            # Legacy GPT-4 (still supported)
            ...
            # Audio - Per MINUTE (not per 1K tokens)
            "whisper-1": {"prompt": 0.006, "completion": 0},
        },
        "anthropic": {
        ...
        "deepgram": {
            "nova-2": {"prompt": 0.0058, "completion": 0},  # $0.0058/min (pay-as-you-go)
            "nova-3": {"prompt": 0.0077, "completion": 0},  # $0.0077/min (monolingual)
            "nova-3-multilingual": {"prompt": 0.0092, "completion": 0},
            "flux": {"prompt": 0.0077, "completion": 0},
            "enhanced": {"prompt": 0.0165, "completion": 0},
            "base": {"prompt": 0.0145, "completion": 0},
        },
    }
